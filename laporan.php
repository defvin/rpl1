    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table id="table" class="table table-striped table-bordered table-sm dt-responsive nowrap">
                    <?php
                    if (empty($result)) {
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        ...
                                        <a href="./?x=viewitem&order=<?php echo $row['id_order'] . "&meja=" . $row['meja'] ?>" class="btn btn-info btn-sm me-1">
                                            <i class="bi bi-eye">
